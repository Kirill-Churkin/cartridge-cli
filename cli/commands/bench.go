...
func init() {
	...
	benchCmd.Flags().IntVar(&ctx.Bench.UpdateCount, "delete", 0, "percentage of deletes")
	...
	benchCmd.Flags().IntVar(&ctx.Bench.Buckets, "buckest", 0, "number of buckets in all storages")
}
