...
func init() {
	...
	benchCmd.Flags().IntVar(&ctx.Bench.InsertCount, "insert", 10, "")
	benchCmd.Flags().IntVar(&ctx.Bench.SelectCount, "select", 0, "")
	benchCmd.Flags().IntVar(&ctx.Bench.UpdateCount, "update", 0, "")
