...
type BenchCtx struct {
	...
	DeleteCount          int       // DeleteCount describes the number of delete operations as a percentage.
	...
	Buckets              int       // Buckets describes the number of buckets in all storages.
}
